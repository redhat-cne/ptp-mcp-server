...
class PTPLogParser:
    ...
    def extract_sync_status(self, logs: List[LogEntry], config_tags: Optional[set] = None) -> Dict[str, Any]:
        ...
        if dpll_logs:
            ...
            # Check for Go-style DPLL event logs (state, in_spec, source_lost, on_holdover)
            if "in_spec" in parsed:
            ...
            if dpll_component_logs:
                ...
                # Use DPLL state to determine lock if no Go-style event was found
                if "in_spec" not in parsed:
    ...
    def extract_servo_statistics(self, logs: List[LogEntry], config_tags: Optional[set] = None) -> Dict[str, Any]:
    ...
    def extract_port_transitions(self, logs: List[LogEntry], config_tags: Optional[set] = None) -> Dict[str, Any]:
    ...
    def extract_frequency_trend(self, logs: List[LogEntry], window_minutes: int = 60, config_tags: Optional[set] = None) -> Dict[str, Any]:
    ...
    def extract_holdover_events(self, logs: List[LogEntry], config_tags: Optional[set] = None) -> Dict[str, Any]:
    ...
    def extract_gnss_status(self, logs: List[LogEntry], config_tags: Optional[set] = None) -> Dict[str, Any]:
